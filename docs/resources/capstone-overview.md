...
1. **Graduation Requirement:** Successful completion and presentation of your project is required to complete the bootcamp.

2. **Portfolio Piece:** This project will become a key component of your professional portfolio, showcasing your abilities to potential employers.
...
1. **Original Project:** Develop your own idea from scratch. This is encouraged for students who have a specific interest or problem they want to explore.

2. **Default Capstone:** Choose from one of the provided capstone options. Even if you select a default project, you can still work through the full lifecycle including planning, proposal, and roadmap phases.
...
### Phase 1: Concept pitch (early/mid September)
...
### Phase 2: Proposal (early October)
...
### Phase 5: Presentation and demo (November 11)
...
1. Complete all planning phases (pitch, proposal, roadmap)
2. Deliver a working project that meets your defined MVP
3. Maintain documentation of your process and decisions
4. Present and demo your project to the cohort
...
3. Working code (notebook, scripts, or application)
4. Documentation explaining your approach and final product
